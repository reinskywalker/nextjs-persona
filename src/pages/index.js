        ...
        <section className="min-h-screen">
          ...
          <nav className="py-5 mb-12 flex justify-between items-center dark:text-white sticky top-0 bg-white dark:bg-gray-900 z-50">
            ...
            <ul className="flex items-center space-x-8">
              <li className="hover:text-rose-500 cursor-pointer"><a href="#">Home</a></li>
              <li className="hover:text-rose-500 cursor-pointer"><a href="#profile">Profile</a></li>
              <li className="hover:text-rose-500 cursor-pointer"><a href="#portfolio">Portfolio</a></li>
              <li>
